...
`jdt` shows which process owns a port and which project started it, allowing you to terminate it instantly.
...
You will be asked for confirmation before terminating the process.
